(function() {
    ...
    if(event.record["現住所有無"].value.length===0){
      event.record["住民票_郵便番号"].value="";
      event.record["住民票_都道府県"].value="";
      event.record["住民票_市区町村"].value="";
      event.record["住民票_番地"].value="";
      event.record["住民票_建物名"].value="";
      event.record["住民票_都道府県_カナ"].value="";
      event.record["住民票_市区町村_カナ"].value="";
      event.record["住民票_建物名_カナ"].value="";
      event.record["住民票"].value="";
      event.record["住民票カナ"].value="";
    }else{
      event.record["住民票_郵便番号"].value=event.record["現住所_郵便番号"].value;
      event.record["住民票_都道府県"].value=event.record["現住所_都道府県"].value;
      event.record["住民票_市区町村"].value=event.record["現住所_市区町村"].value;
      event.record["住民票_番地"].value=event.record["現住所_番地"].value;
      event.record["住民票_建物名"].value=event.record["現住所_建物名"].value;
      event.record["住民票_都道府県_カナ"].value=event.record["現住所_都道府県_カナ"].value;
      event.record["住民票_市区町村_カナ"].value=event.record["現住所_市区町村_カナ"].value;
      event.record["住民票_建物名_カナ"].value=event.record["現住所_建物名_カナ"].value;
      event.record["住民票"].value=event.record["現住所"].value;
      event.record["住民票カナ"].value=event.record["現住所カナ"].value;
    }
    return event;
    });
    events = [
        // レコード編集時の処理
        'app.record.edit.change.入社案内_応募者情報の現住所と同じ',
        'app.record.create.change.入社案内_応募者情報の現住所と同じ'
        ]
    kintone.events.on(events,function(event) {
      
    if(event.record["入社案内_応募者情報の現住所と同じ"].value.length===0){
      event.record["入社案内＿郵便番号"].value="";
      event.record["入社案内＿住所"].value="";
    }else{
      event.record["入社案内＿郵便番号"].value=event.record["現住所_郵便番号"].value;
      event.record["入社案内＿住所"].value=event.record["現住所"].value;
    }
    return event;
    });
})();
