...
(() => {
    ...
    kintone.events.on('app.record.detail.process.proceed', async (event) => {
        ...
        return Swal.fire({
            ...
            html: '<input type="date" id="date_test" style="border: inset; height: 50px; width: 175px; padding-right: 35px; padding-left:20px; text-align: center; font-size: 18px; border-radius: 10px; font-weight: bold;"></input>',
