(function () {
    'use strict';
    var myEvents = ['app.record.create.change.郵便番号', 'app.record.edit.change.郵便番号'];
    var myEvents2 = ['app.record.create.change.配偶者_郵便番号', 'app.record.edit.change.配偶者_郵便番号'];
    var myEvents3 = ['app.record.create.change.郵便番号_配偶者', 'app.record.edit.change.郵便番号_配偶者'];
    var myEvents4 = ['app.record.create.change.現住所・郵便番号', 'app.record.edit.change.現住所・郵便番号'];
    var myEvents5a = ['app.record.create.change.郵便番号_家族_1', 'app.record.edit.change.郵便番号_家族_1'];
    var myEvents5b = ['app.record.create.change.郵便番号_家族_2', 'app.record.edit.change.郵便番号_家族_2'];
    var myEvents5c = ['app.record.create.change.郵便番号_家族_3', 'app.record.edit.change.郵便番号_家族_3'];
    var myEvents5d = ['app.record.create.change.郵便番号_家族_4', 'app.record.edit.change.郵便番号_家族_4'];
    var myEvents5e = ['app.record.create.change.郵便番号_家族_5', 'app.record.edit.change.郵便番号_家族_5'];
    var myEvents5f = ['app.record.create.change.郵便番号_家族_6', 'app.record.edit.change.郵便番号_家族_6'];
    var myEvents5g = ['app.record.create.change.郵便番号_家族_7', 'app.record.edit.change.郵便番号_家族_7'];
    var myEvents5h = ['app.record.create.change.郵便番号_家族_8', 'app.record.edit.change.郵便番号_家族_8'];
    var myEvents5i = ['app.record.create.change.郵便番号_家族_9', 'app.record.edit.change.郵便番号_家族_9'];
    var myEvents5j = ['app.record.create.change.郵便番号_家族_10', 'app.record.edit.change.郵便番号_家族_10'];
    var myEvents6 = ['app.record.create.change.入社案内＿郵便番号', 'app.record.edit.change.入社案内＿郵便番号'];
    var myEvents7 = ['app.record.create.change.現住所_郵便番号', 'app.record.edit.change.現住所_郵便番号'];
    var myEvents8 = ['app.record.create.change.郵便番号_連絡先', 'app.record.edit.change.郵便番号_連絡先'];
